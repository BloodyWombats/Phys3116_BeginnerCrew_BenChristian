...
# Your folder and file names as you’ve set them
...
# ---------------------------
# Feature functions (Harris)
# ---------------------------
def function(n, c):
    """
    PDF's simple column scorer:
      0  -> blank
      1  -> -1.5 <= value <= -0.9
     -1  -> otherwise
